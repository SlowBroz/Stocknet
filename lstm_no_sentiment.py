...
plt.title(f'Return Prediction for {target_symbol} (LSTM, no sentiment)')
plt.xlabel('Date')
plt.ylabel('Return')
plt.legend()
...
plt.title(f'Stock Price Prediction for {target_symbol} (LSTM, no sentiment)')
plt.xlabel('Date')
plt.ylabel('Price')
plt.legend()
plt.xticks(rotation=45)
